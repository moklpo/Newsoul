...
'7845992222:AAEmNnAc_YOisquuMS94qGy2L1dhpBMbc14'
ADMIN_USER_ID = 1250330319
...
def main():
    application = Application.builder().token('7845992222:AAEmNnAc_YOisquuMS94qGy2L1dhpBMbc14').build()
